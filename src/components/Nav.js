        ...
        <Nav>
            <div className={menuIcon ?"navbar active":"navbar"}>
                <ul className='navbar-lists'>
                    ...
                    <li>
                        <NavLink to="/contact" className= "navbar-link" onClick={()=> setMenuIcon(false)}> Contacts</NavLink>
                    </li>
                    <li>
                ...
                <CgMenu className="mobile-nav-icon" name="menu-outline" onClick={()=> setMenuIcon(true)}></CgMenu>   
                <CgClose className="mobile-nav-icon close-outline" name="menu-outline"></CgClose> 
                </div>
